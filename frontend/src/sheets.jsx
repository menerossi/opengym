...
import { t, instrFor, exerciseName, getLang, INSTR_LANGS } from './lib/i18n.js'
...
function ExercisePicker({ onPick, close }) {
  ...
  let base = all.filter(e =>
    ...
    (!ql || exerciseName(e).toLowerCase().includes(ql) || e.n.toLowerCase().includes(ql) || e.tg.includes(ql) || e.eq.includes(ql) || (e.desc || '').toLowerCase().includes(ql)))
